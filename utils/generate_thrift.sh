...
mkdir -p www/cnk_admin_site/thrift_structures
thrift -r -out www/cnk_admin_site/thrift_structures --gen py communication/server.thrift
mv www/cnk_admin_site/thrift_structures/server/Server-remote www/cnk_admin_site/thrift_structures/
