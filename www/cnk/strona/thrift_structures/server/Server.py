...
class Iface:
  ...
  def getMapImageTiles(self, request):
    """
    Parameters:
     - request
    """
...
class Client(Iface):
  ...
  def getMapImageTiles(self, request):
    ...
    Parameters:
     - request
    """
    self.send_getMapImageTiles(request)
    return self.recv_getMapImageTiles()

  def send_getMapImageTiles(self, request):
    self._oprot.writeMessageBegin('getMapImageTiles', TMessageType.CALL, self._seqid)
    args = getMapImageTiles_args()
    args.request = request
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_getMapImageTiles(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = getMapImageTiles_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    if result.err is not None:
      raise result.err
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getMapImageTiles failed: unknown result")
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["getMapImageTiles"] = Processor.process_getMapImageTiles
  ...
  def process_getMapImageTiles(self, seqid, iprot, oprot):
    args = getMapImageTiles_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getMapImageTiles_result()
    try:
      result.success = self._handler.getMapImageTiles(args.request)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except structs.ttypes.InternalError as err:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("getMapImageTiles", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class getMapImageTiles_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'request', (structs.ttypes.MapImageTilesRequest, structs.ttypes.MapImageTilesRequest.thrift_spec), None, ), # 1
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRUCT:
          self.request = structs.ttypes.MapImageTilesRequest()
          self.request.read(iprot)
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getMapImageTiles_args')
    if self.request is not None:
      oprot.writeFieldBegin('request', TType.STRUCT, 1)
      self.request.write(oprot)
      oprot.writeFieldEnd()
...
class getMapImageTiles_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (structs.ttypes.MapImageTilesResponse, structs.ttypes.MapImageTilesResponse.thrift_spec), None, ), # 0
    (1, TType.STRUCT, 'err', (structs.ttypes.InternalError, structs.ttypes.InternalError.thrift_spec), None, ), # 1
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 0:
        if ftype == TType.STRUCT:
          self.success = structs.ttypes.MapImageTilesResponse()
          self.success.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 1:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getMapImageTiles_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.STRUCT, 0)
      self.success.write(oprot)
      oprot.writeFieldEnd()
