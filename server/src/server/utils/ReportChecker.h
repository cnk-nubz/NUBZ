...
//
//    const repository::Experiment &loadedExperiment() const;
//
...
//
//    bool checkQuestionsBeforeCount(std::size_t simpleQuestions, std::size_t
//    multipleChoiceQuestions,
//                                   std::size_t sortQuestions) const;
//    bool checkQuestionsAfterCount(std::size_t simpleQuestions, std::size_t
//    multipleChoiceQuestions,
//                                  std::size_t sortQuestions) const;
//
...
//                             std::size_t multipleChoiceQuestions, std::size_t sortQuestions)
//                             const;
//};
//
